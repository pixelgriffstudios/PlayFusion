...
if [ -f "$SCRIPT_DIR/optical-stream/kazeta-cdstream.c" ]; then
    echo "  -> Building the PlayFusion console-disc bridge..."
    gcc -O2 -Wall -Wextra -Werror \
        "$SCRIPT_DIR/optical-stream/kazeta-cdstream.c" \
        -o "$SCRIPT_DIR/rootfs/usr/bin/kazeta-cdstream" \
...
SERVICES_TO_ENABLE=("keyd.service" "kazeta-profile-loader.service" "NetworkManager.service" "iwd.service" "bluetooth.service" "sshd.service" "playfusion-loose-rom.path")
